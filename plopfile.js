...
module.exports = function (plop) {
  ...
  plop.setGenerator('Action', {
    ...
    actions: function (answers) {
      var actions = []
      var filePath = getProjectPath() + plop.renderString('/src/actions/{{ camelCase group}}.js', answers)
  ...
  plop.setGenerator('Reducer', {
    ...
    actions: function (answers) {
      ...
      actions.push({
        type: 'add',
        path: getProjectPath() + '/src/reducers/{{camelCase name}}.js',
        templateFile: '.plop/reducer.hbs'
      })
      actions.push({
        type: 'modify',
        path: getProjectPath() + '/src/store/reducer.js',
